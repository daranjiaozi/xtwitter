        ...
        <div id="uploadbox">
            ...
            <div id="sharephoto">
                <div id="loadform" style="display:block">
                    ...
                    请选择要上传的图片：
                    <form target="imageUpload" method="post" enctype="multipart/form-data" action="http://bentutu.com/me/index.php?s=/Space/uploadpic" id="upform">
              ...
              <li class="unlight">
              	...
              	<div class="">
              		...
              		<span class="stamp op" style="float:right;white-space:nowrap">
              			<a href="javascript:void(0)" onclick="delmsg('delmsg.php?s=<?= $row['id'] ?>','确实要删除此条广播吗?',this.parentNode.parentNode.parentNode,'')">删除</a>&nbsp;&nbsp;|&nbsp;&nbsp;
              			<a href="javascript:void(0)" onclick="retwit('136')">转播</a>&nbsp;&nbsp;|&nbsp;&nbsp;
              			<a href="javascript:void(0)" onclick="replyajax('<?= $row['id'] ?>')">评论
<? 
...
(<?=$count1[0]?>)
              		...
              		<div class="clearline"></div>
              		<span id="reply_<?= $row['id'] ?>" class="replyspan"></span>
              	</div>
              </li>  
<? } ?>                      
            </ol>
...
<td id="sidebar" rowspan="2"><div class="contenter">
    <div class="sect first-sect" style="margin-bottom:0px">
        <div class="fleft" style="width:60px"><a href="http://bentutu.com/me/index.php?s=/Setting/face" title="修改头像"><img src="http://bentutu.com/me/Public/images/noavatar.jpg" width="50px" height="50px" alt="<?= $_SESSION['loginuser']?>" class="imgborder"></a></div>
        <div class="fleft">
        ...
        <table class="sidetable">
            <tr style="line-height:100%">
                ...
                <td class="gb"><a href="http://bentutu.com/me/index.php?s=/<?= $_SESSION['loginuser']?>/mine"><p><b id="mymsgnum">1</b></p><p>广播</p></a></td>
            </tr>
        </table>
            </div>
