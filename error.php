...
<title>登陆微博_Bentutu ME - 中国Ubuntu和Linux用户微博平台</title>
<link rel="shortcut icon" href="http://bentutu.com/me/Public/images/favicon.ico">
<script type="text/javascript">var etuser='{"siteurl":"http://bentutu.com/me/index.php?s=","pubdir":"http://bentutu.com/me/Public","setok":"login2","my_uid":"","user_name":"","nickname":"","space":""}';var stalk='';</script>
<script type="text/javascript" src="error_files/jquery.js"></script>
<script type="text/javascript" src="error_files/common.js"></script>
<script type="text/javascript" src="error_files/extends.js"></script>
<script type="text/javascript" src="error_files/ye_dialog.js"></script>
<link rel="stylesheet" type="text/css" href="error_files/highslide.htm">
<link rel="stylesheet" type="text/css" href="error_files/style.css">
<!--[if lte IE 6]>
<style type="text/css">
...
<div id="header">
    <div id="navigation">
        <ul>
                    <li class="fright"><a href="http://bentutu.com/me/index.php?s=/register">注册</a></li>
            <li class="fright"><a href="http://bentutu.com/me/index.php?s=/login">登陆</a> | </li>
                </ul>
    </div>
...
<div id="login">
    <div class="indexh" style="margin-bottom: 20px;">
        <div class="taboff"><a href="http://bentutu.com/me/index.php?s=/register">快速注册</a></div>
        <div class="tabon">登陆微博</div>
        <div class="taboff"><a href="http://bentutu.com/me/index.php?s=/reset">忘记密码</a></div>
    </div>
    <form method="post" action="http://bentutu.com/me/index.php?s=/dologin" class="vf lf" style="margin-top: 50px;">
    <p>
        <label class="label_input" for="loginname">用户名 或 Email地址</label>
        <input tabindex="1" id="loginname" name="loginname" class="input_text" type="text">
    </p>
    <p>
        <label class="label_input" for="password">登录密码</label>
        <input tabindex="2" id="password" name="password" class="input_text" value="" maxlength="20" type="password">
    </p>
    <p>
        <label class="label_check" for="rememberMe">
        <input tabindex="3" name="rememberMe" id="rememberMe" class="checkbox" value="on" type="checkbox">&nbsp;&nbsp;下次自动登录
        </label>
    </p>
    <p class="act">
        <input tabindex="4" class="button1" value="立即登录" type="submit">
    </p>
    <input name="__hash__" value="07116cef63d7cbc4bbf03564c6ed2990" type="hidden"></form>
</div>
    </div>
...
</div><div id="footer">Copyright © 2009-2011 <a href="http://www.nextsns.com/" target="_blank">EasyTalk X1.1</a> All Rights Reserved.<a href="http://www.miibeian.gov.cn/" target="_blank">正在备案...</a></div>
...
<div style="position: absolute; display: none; z-index: 9999;" id="livemargins_control"><img src="error_files/monitor-background-horizontal.png" style="position: absolute; left: -77px; top: -5px;" height="5" width="77">	<img src="error_files/monitor-background-vertical.png" style="position: absolute; left: 0pt; top: -5px;">	<img id="monitor-play-button" src="error_files/monitor-play-button.png" onmouseover="this.style.opacity=1" onmouseout="this.style.opacity=0.5" style="position: absolute; left: 1px; top: 0pt; opacity: 0.5; cursor: pointer;"></div></body></html>